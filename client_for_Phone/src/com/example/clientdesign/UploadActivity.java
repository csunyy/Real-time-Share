			...
			public void onClick(View v){
				...
				if(uploadTag > 0){
		        	 AlertDialog.Builder dialog=new AlertDialog.Builder(UploadActivity.this);
					    ...
					    .setMessage("Needing to upload"+uploadTag+"photos!")
					    .setPositiveButton("Uploading", new DialogInterface.OnClickListener() {		
						@Override
		        	 ...
		        	 AlertDialog.Builder dialog=new AlertDialog.Builder(UploadActivity.this);
		        	 dialog.setTitle("Upload fails")
					    .setIcon(android.R.drawable.ic_dialog_info)
					    .setMessage("Upload fails, please check your internet!")
					    .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {		
						@Override
						public void onClick(DialogInterface dialog, int which) {
							dialog.cancel();
